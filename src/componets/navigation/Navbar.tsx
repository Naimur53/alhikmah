        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <span className="text-xl font-bold">আল হিকমাহ</span>
            </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button className="text-gray-700 border border-gray-300 px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-50 transition-colors">
              নতুন / রেজিস্টার
            </button>
          </div>
