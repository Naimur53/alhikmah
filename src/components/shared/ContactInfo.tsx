    ...
    return (
        <div className="space-y-3">
            ...
            <div className="flex items-center pb-[20px] text-[20px] text-white transition-colors hover:text-gray-300">
                <PhoneIcon className="pr-[15px] text-[32px] text-gray-400" />
                <span>০১৩০-৫৫৯৭-১০১৫</span>
            </div>
            <div className="flex items-center pb-[20px] text-[20px] text-white transition-colors hover:text-gray-300">
                <MailIcon className="pr-[15px] text-[32px] text-gray-400" />
                <span>support@alhikmha.com</span>
            </div>
            <div className="flex items-center pb-[20px] text-[20px] text-white transition-colors hover:text-gray-300">
                <MapPinIcon className="pr-[15px] text-[32px] text-gray-400" />
